 ...
 * @see MenuIcon
 */
public abstract class Basement implements Configuration {
    ...
    public Basement(Activity activity, int color, MaterialMenuDrawable.Stroke stroke) {
        this(activity, color, stroke, DEFAULT_TRANSFORM_DURATION);
    }

    public Basement(Activity activity, int color, MaterialMenuDrawable.Stroke stroke, int transformDuration) {

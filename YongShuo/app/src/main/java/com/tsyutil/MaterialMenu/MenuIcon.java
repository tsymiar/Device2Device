 ...
 * <p/>
 * In order to preserve default ActionBar icon click state call {@link Basement#setNeverDrawTouch(boolean)}.
 ...
 */
public class MenuIcon extends Basement {

    public MenuIcon(Activity activity, int color, Stroke stroke) {
        super(activity, color, stroke);
    }

    public MenuIcon(Activity activity, int color, Stroke stroke, int transformDuration) {

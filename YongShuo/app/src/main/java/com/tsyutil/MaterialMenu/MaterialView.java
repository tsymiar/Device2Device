...
package com.tsyutil.MaterialMenu;
...
import static com.tsyutil.MaterialMenu.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.tsyutil.MaterialMenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.tsyutil.MaterialMenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.tsyutil.MaterialMenu.MaterialMenuDrawable.DEFAULT_VISIBLE;
import static com.tsyutil.MaterialMenu.MaterialMenuDrawable.IconState;
import static com.tsyutil.MaterialMenu.MaterialMenuDrawable.Stroke;

/**
 * A basic View wrapper of {@link MaterialMenuDrawable}. Used
 * for custom view ActionBar or other layouts
 */
public class MaterialView extends View implements Configuration {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, R.styleable.MaterialView);

        try {
            int color = attr.getColor(R.styleable.MaterialView_mm_color, DEFAULT_COLOR);
            boolean visible = attr.getBoolean(R.styleable.MaterialView_mm_visible, DEFAULT_VISIBLE);
            int scale = attr.getInteger(R.styleable.MaterialView_mm_scale, DEFAULT_SCALE);
            int transformDuration = attr.getInteger(R.styleable.MaterialView_mm_transformDuration, DEFAULT_TRANSFORM_DURATION);
            Stroke stroke = Stroke.valueOf(attr.getInteger(R.styleable.MaterialView_mm_strokeWidth, 0));
            boolean rtlEnabled = attr.getBoolean(R.styleable.MaterialView_mm_rtlEnabled, false);
